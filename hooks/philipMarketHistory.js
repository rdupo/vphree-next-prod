...
const getTxnHistory = (id) => {
  ...
  const fetchTransactionHistory = async () => {
    ...
    const nftContract = new ethers.Contract(philipAddy, philipAbi, provider);
    const marketplaceContract = new ethers.Contract(philipMarketAddy, philipMarketAbi, provider);

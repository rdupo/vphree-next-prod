      ...
      <div className="page bg-opacity-60 bg-black">
        <div className="content px-8 z-10">
          <div className="row-wrapper block px-0 py-4">
            ...
            <p className="drk-grey-txt mb-4 collection-desc">Hover displays a preview of the wrapped Philip. Wrap your Philips at the <Link href="/hub/philip-intern-project">Phunky Hub</Link></p>
